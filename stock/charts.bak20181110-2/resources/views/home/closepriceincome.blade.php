    ...
    <div class="">
        <div  >
            ...
            <table border="1" >
                ...
                <tr>
                    <td><textarea name="date" rows="30" cols="20"></textarea></td>
                    <td><textarea name="close" rows="30" cols="20"></textarea></td>
                    <td><textarea name="income" rows="30" cols="20"></textarea></td>
